...
def preprocess():
  ctr = 0
  directory = "/home/krishnendu/Desktop/Python/Test_VL/1_Data/"
  dir_out_path = "/home/krishnendu/Desktop/Python/Test_VL/2_Text/"
...
#          print("Running: " + "pdftotext " + odirectory + "/" + z)
          ...
          os.system("mv " + odirectory + "/" + z.replace(".pdf",".txt") + " " + odirectory.replace("Data","Text") + "/")
